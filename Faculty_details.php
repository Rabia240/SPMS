...
<body>
   ...
   <h1 class="text-center">Faculty Information</h1>
...
<label class="form-label" for="add" style="margin-left:180px; margin-bottom: 20px;"><b>Add Faculty from here!</b></label>

<a href="Add_Faculty.php"><td><input class="btn btn-primary w-10" type="button" name="add_btn" value="ADD FACULTY" style="background-color: #24243e"></td></a>
